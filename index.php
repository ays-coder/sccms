...
<nav class="hidden md:flex items-center gap-6">
  ...
  <a href="#" class="nav-link">Contact</a>
        ...
        <div class="flex items-center gap-3">
          <a href="login.php" class="btn-primary">Login<a href="register.php?role=student" class="btn-secondary">Register</a>
     ...
     <main class="flex-1">
      <section class="relative text-white text-center py-20 px-4 bg-gradient-to-r from-blue-600 via-blue-500 to-blue-700">
        <h1 class="text-5xl font-extrabold mb-4">Welcome to <span class="text-yellow-300">Smart Commerce Core</span></h1>
        <p class="max-w-2xl mx-auto text-lg font-light mb-6">Your comprehensive learning management system for commerce education.</p>
